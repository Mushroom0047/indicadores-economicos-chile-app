...
import RocketGirl from "../../assets/rocket-girl.webp"
 ...
 const Faqs = () => {
  return (
    <section className="w-full mx-auto text-center my-20 lg:px-32 lg:mb-40 lg:container" id="faqs">
      <h2 className="text-center text-5xl">PREGUNTAS FRECUENTES</h2>
      <div className="flex flex-wrap">
        <div className="w-full mt-28 bg-white bg-opacity-80 px-8 md:w-2/3 md:mt-16 lg:w-2/3">
          <FaqsAccordion />
        </div>
